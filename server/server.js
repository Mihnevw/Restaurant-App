...
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(http, fs, crypto) :
    typeof define === 'function' && define.amd ? define(['http', 'fs', 'crypto'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.Server = factory(http, fs, crypto));
    ...
    const data = fs.existsSync('./data')
    ? fs.readdirSync('./data').reduce((p, c) => {
        const content = JSON.parse(fs.readFileSync(`./data/${c}`, 'utf-8'));
        const collection = c.slice(0, -5);  // Премахваме разширението .json
        p[collection] = {};
